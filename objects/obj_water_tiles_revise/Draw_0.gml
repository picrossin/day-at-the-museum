...
for (i = 0; i < instance_number(obj_reflected_object); i += 1) {
	...
	//Draw reflection
	draw_sprite_ext(reflections[i].sprite_index, reflections[i].image_index, reflections[i].x - cx, (reflections[i].y+yoff) - cy, reflections[i].image_xscale, -reflections[i].image_yscale, 0, -1, 0.7);
}
